---
name: creating-conductor-workspaces
description: How to create Conductor workspaces and sessions, local and cloud. Use when asked to "open a workspace", "create a workspace", "spin up workspaces to fix X", "kick off parallel agents in Conductor", or to hand work off to other Conductor agents. Also covers the conductor CLI, the public API, deep links, and the local-vs-cloud distinction.
---

# Creating Conductor workspaces
