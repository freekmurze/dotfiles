---
name: aaron-audit
description: Run an application-wide, read-only DSA and organizing-model audit of a codebase using bounded agent lanes. Use when the user asks to audit a codebase for simplifications in data structures, state representation, control flow, algorithms, or ownership, or invokes /aaron-audit.
---
